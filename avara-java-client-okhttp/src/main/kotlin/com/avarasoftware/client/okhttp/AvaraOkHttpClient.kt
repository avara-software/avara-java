...
import com.avarasoftware.client.AvaraClientImpl
...
/**
 * A class that allows building an instance of [AvaraClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class AvaraOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [AvaraClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): AvaraClient = builder().fromEnv().build()
    }

    /** A builder for [AvaraOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AvaraClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AvaraClient =
            AvaraClientImpl(
                clientOptions
                    .httpClient(
