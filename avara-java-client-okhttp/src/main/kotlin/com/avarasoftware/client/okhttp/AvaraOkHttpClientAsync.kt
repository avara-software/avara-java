...
package com.avarasoftware.client.okhttp

import com.avarasoftware.client.AvaraClientAsync
import com.avarasoftware.client.AvaraClientAsyncImpl
import com.avarasoftware.core.ClientOptions
import com.avarasoftware.core.LogLevel
import com.avarasoftware.core.Sleeper
import com.avarasoftware.core.Timeout
...
/**
 * A class that allows building an instance of [AvaraClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class AvaraOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [AvaraClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): AvaraClientAsync = builder().fromEnv().build()
    }

    /** A builder for [AvaraOkHttpClientAsync]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AvaraClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AvaraClientAsync =
            AvaraClientAsyncImpl(
                clientOptions
                    .httpClient(
