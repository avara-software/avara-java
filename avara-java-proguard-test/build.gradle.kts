...
dependencies {
    testImplementation(project(":avara-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../avara-java-core/src/main/resources/META-INF/proguard/avara-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.avarasoftware.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../avara-java-core/src/main/resources/META-INF/proguard/avara-java-core.pro",
