...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(studyListResponse: StudyListResponse) = apply {
            ...
            studyReportStatus = studyListResponse.studyReportStatus
            updatedAt = studyListResponse.updatedAt
            assignedTo = studyListResponse.assignedTo
            clinicalHistory = studyListResponse.clinicalHistory
            clinicalIndication = studyListResponse.clinicalIndication
            createdByApiKey = studyListResponse.createdByApiKey
            createdByUser = studyListResponse.createdByUser
            expressCustomer = studyListResponse.expressCustomer
            externalPatientId = studyListResponse.externalPatientId
            externalReportId = studyListResponse.externalReportId
            isCritical = studyListResponse.isCritical
            metadata = studyListResponse.metadata
            modality = studyListResponse.modality
            priorReports = studyListResponse.priorReports.map { it.toMutableList() }
            reportIds = studyListResponse.reportIds.map { it.toMutableList() }
            studyType = studyListResponse.studyType
            technologistNotes = studyListResponse.technologistNotes.map { it.toMutableList() }
            technologistTechnique = studyListResponse.technologistTechnique
