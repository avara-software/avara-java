...
/**
 * Retrieves presigned URLs for accessing report PDFs. Can fetch a single report by report ID, or
 * all reports for a study by study ID/DICOM UID. URLs are time-limited for security.
 */
class ReportPdfParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ReportPdfParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ReportPdfParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ReportPdfParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(reportPdfParams: ReportPdfParams) = apply {
            reportId = reportPdfParams.reportId
            studyId = reportPdfParams.studyId
            studyInstanceUid = reportPdfParams.studyInstanceUid
            additionalHeaders = reportPdfParams.additionalHeaders.toBuilder()
            additionalQueryParams = reportPdfParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ReportPdfParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ReportPdfParams =
            ReportPdfParams(
                reportId,
                studyId,
                studyInstanceUid,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReportPdfParams &&
    ...
    override fun toString() =
        "ReportPdfParams{reportId=$reportId, studyId=$studyId, studyInstanceUid=$studyInstanceUid, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
