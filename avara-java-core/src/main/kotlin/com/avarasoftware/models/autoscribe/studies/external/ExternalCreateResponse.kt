...
import com.avarasoftware.models.autoscribe.studies.PriorReport
import com.avarasoftware.models.autoscribe.studies.ReportIdWithStatus
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExternalCreateResponse].
         *
    ...
    /** A builder for [ExternalCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(externalCreateResponse: ExternalCreateResponse) = apply {
            cancelledAt = externalCreateResponse.cancelledAt
            createdAt = externalCreateResponse.createdAt
            isCancelled = externalCreateResponse.isCancelled
            reportMetadata = externalCreateResponse.reportMetadata
            severity = externalCreateResponse.severity
            studyDescription = externalCreateResponse.studyDescription
            studyId = externalCreateResponse.studyId
            studyInstanceUid = externalCreateResponse.studyInstanceUid
            studyReportStatus = externalCreateResponse.studyReportStatus
            updatedAt = externalCreateResponse.updatedAt
            assignedTo = externalCreateResponse.assignedTo
            clinicalHistory = externalCreateResponse.clinicalHistory
            clinicalIndication = externalCreateResponse.clinicalIndication
            createdByApiKey = externalCreateResponse.createdByApiKey
            createdByUser = externalCreateResponse.createdByUser
            expressCustomer = externalCreateResponse.expressCustomer
            externalPatientId = externalCreateResponse.externalPatientId
            externalReportId = externalCreateResponse.externalReportId
            isCritical = externalCreateResponse.isCritical
            metadata = externalCreateResponse.metadata
            modality = externalCreateResponse.modality
            priorReports = externalCreateResponse.priorReports.map { it.toMutableList() }
            reportIds = externalCreateResponse.reportIds.map { it.toMutableList() }
            studyType = externalCreateResponse.studyType
            technologistNotes = externalCreateResponse.technologistNotes.map { it.toMutableList() }
            technologistTechnique = externalCreateResponse.technologistTechnique
            additionalProperties = externalCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalCreateResponse].
         *
         ...
         */
        fun build(): ExternalCreateResponse =
     ...
     *   type.
     */
    fun validate(): ExternalCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalCreateResponse &&
