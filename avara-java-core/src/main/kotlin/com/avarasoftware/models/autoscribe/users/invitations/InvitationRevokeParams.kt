...
private constructor(
     ...
     */
    fun invitationId(): Optional<String> = body.invitationId()
     ...
     */
    fun _invitationId(): JsonField<String> = body._invitationId()
    ...
    companion object {
        ...
        @JvmStatic fun none(): InvitationRevokeParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [InvitationRevokeParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [InvitationRevokeParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(invitationRevokeParams: InvitationRevokeParams) = apply {
            body = invitationRevokeParams.body.toBuilder()
            additionalHeaders = invitationRevokeParams.additionalHeaders.toBuilder()
            additionalQueryParams = invitationRevokeParams.additionalQueryParams.toBuilder()
        }
        ...
        /** Invitation ID to revoke. Format: inv_{32-hex-chars} */
        fun invitationId(invitationId: String) = apply { body.invitationId(invitationId) }
        ...
        /**
         * Returns an immutable instance of [InvitationRevokeParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InvitationRevokeParams =
    ...
    /** Request body for revoking an invitation in AutoScribe */
    class Body
    ...
    private constructor(
        ...
        ) : this(invitationId, userId, mutableMapOf())
         ...
         *   server responded with an unexpected value).
         */
        fun invitationId(): Optional<String> = invitationId.getOptional("invitationId")
         ...
         * Returns the raw JSON value of [invitationId].
         *
         * Unlike [invitationId], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("invitationId")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            private var invitationId: JsonField<String> = JsonMissing.of()
             ...
             * Sets [Builder.invitationId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.invitationId] with a well-typed [String] value
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(invitationId, userId, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(invitationId, userId, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{invitationId=$invitationId, userId=$userId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvitationRevokeParams &&
            body == other.body &&
    ...
    override fun toString() =
        "InvitationRevokeParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
