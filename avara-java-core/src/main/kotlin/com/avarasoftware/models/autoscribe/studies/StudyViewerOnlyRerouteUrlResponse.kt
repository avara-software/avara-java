...
private constructor(
    ...
    /** A builder for [StudyViewerOnlyRerouteUrlResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(studyViewerOnlyRerouteUrlResponse: StudyViewerOnlyRerouteUrlResponse) =
            apply {
                url = studyViewerOnlyRerouteUrlResponse.url
                additionalProperties =
                    studyViewerOnlyRerouteUrlResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [StudyViewerOnlyRerouteUrlResponse].
         *
         ...
         */
        fun build(): StudyViewerOnlyRerouteUrlResponse =
            StudyViewerOnlyRerouteUrlResponse(
     ...
     *   type.
     */
    fun validate(): StudyViewerOnlyRerouteUrlResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StudyViewerOnlyRerouteUrlResponse &&
            url == other.url &&
    ...
    override fun toString() =
        "StudyViewerOnlyRerouteUrlResponse{url=$url, additionalProperties=$additionalProperties}"
}
