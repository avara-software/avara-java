 ...
 */
class ClinicalReferenceType @JsonCreator private constructor(private val value: JsonField<String>) :
    Enum {
    ...
    companion object {
        ...
        @JvmField val FACILITY = of("facility")

        @JvmField val REFERRING_PROVIDER = of("referring_provider")
    ...
    /** An enum containing [ClinicalReferenceType]'s known values. */
    enum class Known {
        FACILITY,
        REFERRING_PROVIDER,
        STUDY_DESCRIPTION,
    ...
    /**
     * An enum containing [ClinicalReferenceType]'s known values, as well as an [_UNKNOWN] member.
     *
     * An instance of [ClinicalReferenceType] can contain an unknown value in a couple of cases:
     ...
     *   type.
     */
    fun validate(): ClinicalReferenceType = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ClinicalReferenceType && value == other.value
    }
