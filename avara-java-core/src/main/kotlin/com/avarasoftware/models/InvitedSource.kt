...
class InvitedSource @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    enum class Value {
        ...
        API,
        /**
         * An enum member indicating that [InvitedSource] was instantiated with an unknown value.
         */
        _UNKNOWN,
    }
