...
private constructor(
    ...
    private val studyViewerStatus: StudyViewerStatus?,
    ...
    fun studyViewerStatus(): Optional<StudyViewerStatus> = Optional.ofNullable(studyViewerStatus)
    ...
    class Builder internal constructor() {
        ...
        private var studyViewerStatus: StudyViewerStatus? = null
        ...
        internal fun from(studyListParams: StudyListParams) = apply {
            ...
            studyViewerStatus = studyListParams.studyViewerStatus
        ...
        /** Alias for calling [Builder.studyViewerStatus] with `studyViewerStatus.orElse(null)`. */
        fun studyViewerStatus(studyViewerStatus: Optional<StudyViewerStatus>) =
            studyViewerStatus(studyViewerStatus.getOrNull())
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                studyViewerStatus?.let { put("studyViewerStatus", it.toString()) }
    ...
    override fun toString() =
        "StudyListParams{assignedTo=$assignedTo, cursor=$cursor, expressCustomerId=$expressCustomerId, isCancelled=$isCancelled, limit=$limit, severity=$severity, studyDescription=$studyDescription, studyViewerStatus=$studyViewerStatus, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
