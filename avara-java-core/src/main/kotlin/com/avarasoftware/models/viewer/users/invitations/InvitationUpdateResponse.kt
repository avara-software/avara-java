...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [InvitationUpdateResponse].
         *
    ...
    /** A builder for [InvitationUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(invitationUpdateResponse: InvitationUpdateResponse) = apply {
            canManageStudies = invitationUpdateResponse.canManageStudies
            clinicId = invitationUpdateResponse.clinicId
            clinicRole = invitationUpdateResponse.clinicRole
            createdAt = invitationUpdateResponse.createdAt
            email = invitationUpdateResponse.email
            expiry = invitationUpdateResponse.expiry
            firstName = invitationUpdateResponse.firstName
            hasDashboardAccess = invitationUpdateResponse.hasDashboardAccess
            invitationId = invitationUpdateResponse.invitationId
            invitedSource = invitationUpdateResponse.invitedSource
            inviterId = invitationUpdateResponse.inviterId
            lastName = invitationUpdateResponse.lastName
            level = invitationUpdateResponse.level
            status = invitationUpdateResponse.status
            updatedAt = invitationUpdateResponse.updatedAt
            userId = invitationUpdateResponse.userId
            invitedByApiKeyId = invitationUpdateResponse.invitedByApiKeyId
            middleName = invitationUpdateResponse.middleName
            phoneNumber = invitationUpdateResponse.phoneNumber
            suffix1 = invitationUpdateResponse.suffix1
            suffix2 = invitationUpdateResponse.suffix2
            additionalProperties = invitationUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InvitationUpdateResponse].
         *
         ...
         */
        fun build(): InvitationUpdateResponse =
     ...
     *   type.
     */
    fun validate(): InvitationUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvitationUpdateResponse &&
