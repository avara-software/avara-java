...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExpressRetrieveResponse].
         *
    ...
    /** A builder for [ExpressRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(expressRetrieveResponse: ExpressRetrieveResponse) = apply {
            createdAt = expressRetrieveResponse.createdAt
            expressCustomerId = expressRetrieveResponse.expressCustomerId
            expressCustomerName = expressRetrieveResponse.expressCustomerName
            isActive = expressRetrieveResponse.isActive
            updatedAt = expressRetrieveResponse.updatedAt
            userCount = expressRetrieveResponse.userCount
            createdByApiKeyId = expressRetrieveResponse.createdByApiKeyId
            createdByUserId = expressRetrieveResponse.createdByUserId
            metadata = expressRetrieveResponse.metadata
            additionalProperties = expressRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExpressRetrieveResponse].
         *
         ...
         */
        fun build(): ExpressRetrieveResponse =
     ...
     *   type.
     */
    fun validate(): ExpressRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpressRetrieveResponse &&
