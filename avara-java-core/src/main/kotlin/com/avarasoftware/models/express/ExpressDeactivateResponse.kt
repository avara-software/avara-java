...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExpressDeactivateResponse].
         *
    ...
    /** A builder for [ExpressDeactivateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(expressDeactivateResponse: ExpressDeactivateResponse) = apply {
            createdAt = expressDeactivateResponse.createdAt
            expressCustomerId = expressDeactivateResponse.expressCustomerId
            expressCustomerName = expressDeactivateResponse.expressCustomerName
            isActive = expressDeactivateResponse.isActive
            updatedAt = expressDeactivateResponse.updatedAt
            userCount = expressDeactivateResponse.userCount
            createdByApiKeyId = expressDeactivateResponse.createdByApiKeyId
            createdByUserId = expressDeactivateResponse.createdByUserId
            metadata = expressDeactivateResponse.metadata
            additionalProperties = expressDeactivateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExpressDeactivateResponse].
         *
         ...
         */
        fun build(): ExpressDeactivateResponse =
     ...
     *   type.
     */
    fun validate(): ExpressDeactivateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpressDeactivateResponse &&
