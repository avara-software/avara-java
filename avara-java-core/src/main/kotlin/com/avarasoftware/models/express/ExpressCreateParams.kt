...
private constructor(
     ...
     */
    fun expressCustomerName(): String = body.expressCustomerName()
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExpressCreateParams].
         *
    ...
    /** A builder for [ExpressCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(expressCreateParams: ExpressCreateParams) = apply {
            body = expressCreateParams.body.toBuilder()
            additionalHeaders = expressCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = expressCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ExpressCreateParams].
         *
    ...
    /** Request body for creating an Express customer */
    class Body
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpressCreateParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ExpressCreateParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
