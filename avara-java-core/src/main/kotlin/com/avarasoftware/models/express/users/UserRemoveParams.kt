...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userRemoveParams: UserRemoveParams) = apply {
            expressCustomerId = userRemoveParams.expressCustomerId
    ...
    /** Request body for removing a user from an Express customer */
    class Body
    ...
    override fun toString() =
        "UserRemoveParams{expressCustomerId=$expressCustomerId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
