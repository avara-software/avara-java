...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExpressUpdateResponse].
         *
    ...
    /** A builder for [ExpressUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(expressUpdateResponse: ExpressUpdateResponse) = apply {
            createdAt = expressUpdateResponse.createdAt
            expressCustomerId = expressUpdateResponse.expressCustomerId
            expressCustomerName = expressUpdateResponse.expressCustomerName
            isActive = expressUpdateResponse.isActive
            updatedAt = expressUpdateResponse.updatedAt
            userCount = expressUpdateResponse.userCount
            createdByApiKeyId = expressUpdateResponse.createdByApiKeyId
            createdByUserId = expressUpdateResponse.createdByUserId
            metadata = expressUpdateResponse.metadata
            additionalProperties = expressUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExpressUpdateResponse].
         *
         ...
         */
        fun build(): ExpressUpdateResponse =
     ...
     *   type.
     */
    fun validate(): ExpressUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpressUpdateResponse &&
