...
/**
 * Associates an existing user with a customer, granting them access to customer-specific resources
 * and studies.
 */
class UserAddParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userAddParams: UserAddParams) = apply {
            expressCustomerId = userAddParams.expressCustomerId
            body = userAddParams.body.toBuilder()
    ...
    /** Request body for adding a user to an Express customer */
    class Body
    ...
    override fun toString() =
        "UserAddParams{expressCustomerId=$expressCustomerId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
