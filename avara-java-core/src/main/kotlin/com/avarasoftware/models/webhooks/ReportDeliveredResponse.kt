...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ReportDeliveredResponse].
         *
    ...
    /** A builder for [ReportDeliveredResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(reportDeliveredResponse: ReportDeliveredResponse) = apply {
            success = reportDeliveredResponse.success
            additionalProperties = reportDeliveredResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ReportDeliveredResponse].
         *
         ...
         */
        fun build(): ReportDeliveredResponse =
     ...
     *   type.
     */
    fun validate(): ReportDeliveredResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ReportDeliveredResponse &&
    ...
    override fun toString() =
        "ReportDeliveredResponse{success=$success, additionalProperties=$additionalProperties}"
}
