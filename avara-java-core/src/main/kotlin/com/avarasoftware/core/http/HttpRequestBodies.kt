...
import com.avarasoftware.core.MultipartField
...
private fun serializePart(name: String, node: JsonNode): Sequence<Pair<String, InputStream>> =
    when (node.nodeType) {
                    ...
                    node
                        ...
                        .mapNotNull { element ->
                            when (element.nodeType) {
                                ...
                                JsonNodeType.OBJECT,
                                JsonNodeType.POJO ->
                                    throw AvaraInvalidDataException(
        ...
        JsonNodeType.POJO,
        null -> throw AvaraInvalidDataException("Unexpected JsonNode type: ${node.nodeType}")
    }
