...
private constructor(
    private val canCreateReports: Boolean?,
    ...
    fun canCreateReports(): Optional<Boolean> = Optional.ofNullable(canCreateReports)
    ...
    class Builder internal constructor() {
        ...
        private var canCreateReports: Boolean? = null
        ...
        internal fun from(userListParams: UserListParams) = apply {
            canCreateReports = userListParams.canCreateReports
        ...
        /**
         * Alias for [Builder.canCreateReports].
         *
         * This unboxed primitive overload exists for backwards compatibility.
         */
        fun canCreateReports(canCreateReports: Boolean) =
            canCreateReports(canCreateReports as Boolean?)

        /** Alias for calling [Builder.canCreateReports] with `canCreateReports.orElse(null)`. */
        fun canCreateReports(canCreateReports: Optional<Boolean>) =
            canCreateReports(canCreateReports.getOrNull())
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                canCreateReports?.let { put("canCreateReports", it.toString()) }
    ...
    override fun toString() =
        "UserListParams{canCreateReports=$canCreateReports, cursor=$cursor, email=$email, firstName=$firstName, invitedSource=$invitedSource, lastName=$lastName, level=$level, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
