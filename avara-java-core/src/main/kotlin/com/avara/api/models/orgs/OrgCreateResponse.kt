...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrgCreateResponse].
         *
    ...
    /** A builder for [OrgCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orgCreateResponse: OrgCreateResponse) = apply {
            createdAt = orgCreateResponse.createdAt
            isActive = orgCreateResponse.isActive
            orgId = orgCreateResponse.orgId
            orgName = orgCreateResponse.orgName
            updatedAt = orgCreateResponse.updatedAt
            userCount = orgCreateResponse.userCount
            createdByApiKeyId = orgCreateResponse.createdByApiKeyId
            createdByUserId = orgCreateResponse.createdByUserId
            metadata = orgCreateResponse.metadata
            additionalProperties = orgCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrgCreateResponse].
         *
    ...
    fun validate(): OrgCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrgCreateResponse &&
    ...
    override fun toString() =
        "OrgCreateResponse{createdAt=$createdAt, isActive=$isActive, orgId=$orgId, orgName=$orgName, updatedAt=$updatedAt, userCount=$userCount, createdByApiKeyId=$createdByApiKeyId, createdByUserId=$createdByUserId, metadata=$metadata, additionalProperties=$additionalProperties}"
}
