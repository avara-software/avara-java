 ...
 * either study ID or DICOM Study Instance UID. Returns report metadata including status, version,
 * and timestamps.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(reportListParams: ReportListParams) = apply {
            ...
            studyInstanceUid = reportListParams.studyInstanceUid
    ...
    override fun hashCode(): Int =
        Objects.hash(studyId, studyInstanceUid, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "ReportListParams{studyId=$studyId, studyInstanceUid=$studyInstanceUid, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
