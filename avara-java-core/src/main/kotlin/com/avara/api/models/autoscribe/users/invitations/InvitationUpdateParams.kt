...
/**
 * Updates a pending invitation's user details, permissions, and AutoScribe-specific settings before
 * it is accepted. Only valid for invitations that have not expired or been processed. NPI number is
 * required if enabling report creation.
 */
...
private constructor(
    ...
    /** Request body for updating an invitation in AutoScribe */
    class Body
