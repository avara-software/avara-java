...
/**
 * Retrieves a paginated list of organizations with optional filtering by name. Returns up to 100
 * organizations per request.
 */
class OrgListParams
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(orgListParams: OrgListParams) = apply {
            cursor = orgListParams.cursor
            limit = orgListParams.limit
        ...
        fun build(): OrgListParams =
            OrgListParams(cursor, limit, additionalHeaders.build(), additionalQueryParams.build())
    }
    ...
    override fun toString() =
        "OrgListParams{cursor=$cursor, limit=$limit, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
