...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrgListResponse].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orgListResponse: OrgListResponse) = apply {
            createdAt = orgListResponse.createdAt
            isActive = orgListResponse.isActive
            orgId = orgListResponse.orgId
            orgName = orgListResponse.orgName
            updatedAt = orgListResponse.updatedAt
            userCount = orgListResponse.userCount
            createdByApiKeyId = orgListResponse.createdByApiKeyId
            createdByUserId = orgListResponse.createdByUserId
            metadata = orgListResponse.metadata
            additionalProperties = orgListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrgListResponse].
         *
    ...
    fun validate(): OrgListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrgListResponse &&
    ...
    override fun toString() =
        "OrgListResponse{createdAt=$createdAt, isActive=$isActive, orgId=$orgId, orgName=$orgName, updatedAt=$updatedAt, userCount=$userCount, createdByApiKeyId=$createdByApiKeyId, createdByUserId=$createdByUserId, metadata=$metadata, additionalProperties=$additionalProperties}"
}
