...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrgDeactivateResponse].
         *
    ...
    /** A builder for [OrgDeactivateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orgDeactivateResponse: OrgDeactivateResponse) = apply {
            createdAt = orgDeactivateResponse.createdAt
            isActive = orgDeactivateResponse.isActive
            orgId = orgDeactivateResponse.orgId
            orgName = orgDeactivateResponse.orgName
            updatedAt = orgDeactivateResponse.updatedAt
            userCount = orgDeactivateResponse.userCount
            createdByApiKeyId = orgDeactivateResponse.createdByApiKeyId
            createdByUserId = orgDeactivateResponse.createdByUserId
            metadata = orgDeactivateResponse.metadata
            additionalProperties = orgDeactivateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrgDeactivateResponse].
         *
         ...
         */
        fun build(): OrgDeactivateResponse =
    ...
    fun validate(): OrgDeactivateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrgDeactivateResponse &&
    ...
    override fun toString() =
        "OrgDeactivateResponse{createdAt=$createdAt, isActive=$isActive, orgId=$orgId, orgName=$orgName, updatedAt=$updatedAt, userCount=$userCount, createdByApiKeyId=$createdByApiKeyId, createdByUserId=$createdByUserId, metadata=$metadata, additionalProperties=$additionalProperties}"
}
