...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): StudyCancelParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [StudyCancelParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [StudyCancelParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(studyCancelParams: StudyCancelParams) = apply {
            body = studyCancelParams.body.toBuilder()
            additionalHeaders = studyCancelParams.additionalHeaders.toBuilder()
            additionalQueryParams = studyCancelParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [StudyCancelParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StudyCancelParams =
            StudyCancelParams(
                body.build(),
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StudyCancelParams &&
            body == other.body &&
    ...
    override fun toString() =
        "StudyCancelParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
