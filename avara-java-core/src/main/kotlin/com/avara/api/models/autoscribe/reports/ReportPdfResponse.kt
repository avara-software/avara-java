...
import com.avara.api.core.BaseDeserializer
import com.avara.api.core.BaseSerializer
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                internal fun from(report: Report) = apply {
                    presignedUrl = report.presignedUrl
            ...
            override fun toString() =
                "Report{presignedUrl=$presignedUrl, reportId=$reportId, snapshotMetadata=$snapshotMetadata, studyId=$studyId, studyInstanceUid=$studyInstanceUid, additionalProperties=$additionalProperties}"
        }
