...
private constructor(
     ...
     *
     * Defaults to [com.avara.core.jsonMapper]. The default is usually sufficient and rarely needs
     * to be overridden.
     */
    ...
    class Builder internal constructor() {
         ...
         * The Jackson JSON mapper to use for serializing and deserializing JSON.
         *
         * Defaults to [com.avara.core.jsonMapper]. The default is usually sufficient and rarely
