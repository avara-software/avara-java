...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userListResponse: UserListResponse) = apply {
            canManageStudies = userListResponse.canManageStudies
            clinicRole = userListResponse.clinicRole
            createdAt = userListResponse.createdAt
            email = userListResponse.email
            firstName = userListResponse.firstName
            hasDashboardAccess = userListResponse.hasDashboardAccess
            invitedSource = userListResponse.invitedSource
            lastLoginAt = userListResponse.lastLoginAt
            lastName = userListResponse.lastName
            level = userListResponse.level
            userId = userListResponse.userId
            middleName = userListResponse.middleName
            phoneNumber = userListResponse.phoneNumber
            suffix1 = userListResponse.suffix1
            suffix2 = userListResponse.suffix2
    ...
    override fun toString() =
        "UserListResponse{canManageStudies=$canManageStudies, clinicRole=$clinicRole, createdAt=$createdAt, email=$email, firstName=$firstName, hasDashboardAccess=$hasDashboardAccess, invitedSource=$invitedSource, lastLoginAt=$lastLoginAt, lastName=$lastName, level=$level, userId=$userId, middleName=$middleName, phoneNumber=$phoneNumber, suffix1=$suffix1, suffix2=$suffix2, additionalProperties=$additionalProperties}"
}
