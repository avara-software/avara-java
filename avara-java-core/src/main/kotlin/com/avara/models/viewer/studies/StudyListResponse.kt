...
private constructor(
    ...
    private val org: JsonField<OrgReference>,
    ...
    private constructor(
        ...
        @JsonProperty("org") @ExcludeMissing org: JsonField<OrgReference> = JsonMissing.of(),
    ) : this(
        cancelledAt,
        createdAt,
        isCancelled,
     ...
     *   server responded with an unexpected value).
     */
    fun org(): Optional<OrgReference> = org.getOptional("org")
     ...
     */
    @JsonProperty("org") @ExcludeMissing fun _org(): JsonField<OrgReference> = org
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StudyListResponse].
         *
    ...
    /** A builder for [StudyListResponse]. */
    class Builder internal constructor() {
        ...
        private var org: JsonField<OrgReference> = JsonMissing.of()
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(studyListResponse: StudyListResponse) = apply {
            cancelledAt = studyListResponse.cancelledAt
            createdAt = studyListResponse.createdAt
            isCancelled = studyListResponse.isCancelled
            severity = studyListResponse.severity
            studyDescription = studyListResponse.studyDescription
            studyId = studyListResponse.studyId
            studyInstanceUid = studyListResponse.studyInstanceUid
            studyViewerStatus = studyListResponse.studyViewerStatus
            updatedAt = studyListResponse.updatedAt
            assignedTo = studyListResponse.assignedTo
            createdByApiKey = studyListResponse.createdByApiKey
            createdByUser = studyListResponse.createdByUser
            metadata = studyListResponse.metadata
            org = studyListResponse.org
            additionalProperties = studyListResponse.additionalProperties.toMutableMap()
        }
        ...
        /** A reference to an organization with basic identifying information */
        fun org(org: OrgReference?) = org(JsonField.ofNullable(org))

        /** Alias for calling [Builder.org] with `org.orElse(null)`. */
        fun org(org: Optional<OrgReference>) = org(org.getOrNull())

        /**
         * Sets [Builder.org] to an arbitrary JSON value.
         *
         * You should usually call [Builder.org] with a well-typed [OrgReference] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun org(org: JsonField<OrgReference>) = apply { this.org = org }
        ...
        /**
         * Returns an immutable instance of [StudyListResponse].
         *
    ...
    fun validate(): StudyListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StudyListResponse &&
    ...
    override fun toString() =
        "StudyListResponse{cancelledAt=$cancelledAt, createdAt=$createdAt, isCancelled=$isCancelled, severity=$severity, studyDescription=$studyDescription, studyId=$studyId, studyInstanceUid=$studyInstanceUid, studyViewerStatus=$studyViewerStatus, updatedAt=$updatedAt, assignedTo=$assignedTo, createdByApiKey=$createdByApiKey, createdByUser=$createdByUser, metadata=$metadata, org=$org, additionalProperties=$additionalProperties}"
}
