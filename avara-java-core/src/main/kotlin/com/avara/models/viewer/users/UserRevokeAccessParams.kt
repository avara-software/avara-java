...
/**
 * Deactivates a user's access to the system. The user will no longer be able to log in or access
 * resources. User data is preserved and can be reactivated later.
 */
class UserRevokeAccessParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UserRevokeAccessParams].
         *
    ...
    /** A builder for [UserRevokeAccessParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(userRevokeAccessParams: UserRevokeAccessParams) = apply {
            body = userRevokeAccessParams.body.toBuilder()
            additionalHeaders = userRevokeAccessParams.additionalHeaders.toBuilder()
            additionalQueryParams = userRevokeAccessParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UserRevokeAccessParams].
         *
         ...
         */
        fun build(): UserRevokeAccessParams =
    ...
    /** Request body for revoking user access in Viewer */
    class Body
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UserRevokeAccessParams &&
            body == other.body &&
    ...
    override fun toString() =
        "UserRevokeAccessParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
