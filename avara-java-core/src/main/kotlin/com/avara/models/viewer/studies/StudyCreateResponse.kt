...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [StudyCreateResponse].
         *
    ...
    /** A builder for [StudyCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(studyCreateResponse: StudyCreateResponse) = apply {
            cancelledAt = studyCreateResponse.cancelledAt
            createdAt = studyCreateResponse.createdAt
            isCancelled = studyCreateResponse.isCancelled
            severity = studyCreateResponse.severity
            studyDescription = studyCreateResponse.studyDescription
            studyId = studyCreateResponse.studyId
            studyInstanceUid = studyCreateResponse.studyInstanceUid
            studyViewerStatus = studyCreateResponse.studyViewerStatus
            updatedAt = studyCreateResponse.updatedAt
            assignedTo = studyCreateResponse.assignedTo
            createdByApiKey = studyCreateResponse.createdByApiKey
            createdByUser = studyCreateResponse.createdByUser
            metadata = studyCreateResponse.metadata
            org = studyCreateResponse.org
        ...
        /**
         * Returns an immutable instance of [StudyCreateResponse].
         *
    ...
    fun validate(): StudyCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StudyCreateResponse &&
    ...
    override fun toString() =
        "StudyCreateResponse{cancelledAt=$cancelledAt, createdAt=$createdAt, isCancelled=$isCancelled, severity=$severity, studyDescription=$studyDescription, studyId=$studyId, studyInstanceUid=$studyInstanceUid, studyViewerStatus=$studyViewerStatus, updatedAt=$updatedAt, assignedTo=$assignedTo, createdByApiKey=$createdByApiKey, createdByUser=$createdByUser, metadata=$metadata, org=$org, additionalProperties=$additionalProperties}"
}
