...
/**
 * Creates a new user in the Viewer system and sends them an invitation email. The user will have
 * the specified permissions and access level. Dashboard access can be enabled to allow login.
 */
...
private constructor(
    ...
    /** Request body for inviting a user to Viewer */
    class Body
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{canManageStudies=$canManageStudies, clinicRole=$clinicRole, email=$email, firstName=$firstName, hasDashboardAccess=$hasDashboardAccess, lastName=$lastName, level=$level, middleName=$middleName, phoneNumber=$phoneNumber, suffix1=$suffix1, suffix2=$suffix2, additionalProperties=$additionalProperties}"
    }
