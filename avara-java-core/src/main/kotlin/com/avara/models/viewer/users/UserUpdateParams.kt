...
/**
 * Updates a user's profile information, permissions, and access level. All fields are optional -
 * only provided fields will be updated. Email cannot be changed via API.
 */
...
private constructor(
    ...
    /** Request body for updating a user in Viewer */
    class Body
