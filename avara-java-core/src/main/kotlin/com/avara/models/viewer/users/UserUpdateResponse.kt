...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userUpdateResponse: UserUpdateResponse) = apply {
            canManageStudies = userUpdateResponse.canManageStudies
            clinicRole = userUpdateResponse.clinicRole
            createdAt = userUpdateResponse.createdAt
            email = userUpdateResponse.email
            firstName = userUpdateResponse.firstName
            hasDashboardAccess = userUpdateResponse.hasDashboardAccess
            invitedSource = userUpdateResponse.invitedSource
            lastLoginAt = userUpdateResponse.lastLoginAt
            lastName = userUpdateResponse.lastName
            level = userUpdateResponse.level
            userId = userUpdateResponse.userId
            middleName = userUpdateResponse.middleName
            phoneNumber = userUpdateResponse.phoneNumber
            suffix1 = userUpdateResponse.suffix1
            suffix2 = userUpdateResponse.suffix2
    ...
    override fun toString() =
        "UserUpdateResponse{canManageStudies=$canManageStudies, clinicRole=$clinicRole, createdAt=$createdAt, email=$email, firstName=$firstName, hasDashboardAccess=$hasDashboardAccess, invitedSource=$invitedSource, lastLoginAt=$lastLoginAt, lastName=$lastName, level=$level, userId=$userId, middleName=$middleName, phoneNumber=$phoneNumber, suffix1=$suffix1, suffix2=$suffix2, additionalProperties=$additionalProperties}"
}
