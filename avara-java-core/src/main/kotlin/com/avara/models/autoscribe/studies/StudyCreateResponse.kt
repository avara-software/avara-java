...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(studyCreateResponse: StudyCreateResponse) = apply {
            ...
            studyReportStatus = studyCreateResponse.studyReportStatus
            ...
            priorReportTexts = studyCreateResponse.priorReportTexts.map { it.toMutableList() }
            priorStudyIds = studyCreateResponse.priorStudyIds.map { it.toMutableList() }
