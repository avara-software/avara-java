...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(studyRetrieveResponse: StudyRetrieveResponse) = apply {
            ...
            studyReportStatus = studyRetrieveResponse.studyReportStatus
            updatedAt = studyRetrieveResponse.updatedAt
            assignedTo = studyRetrieveResponse.assignedTo
            clinicalHistory = studyRetrieveResponse.clinicalHistory
            clinicalIndication = studyRetrieveResponse.clinicalIndication
            ...
            externalPatientId = studyRetrieveResponse.externalPatientId
            externalReportId = studyRetrieveResponse.externalReportId
            isCritical = studyRetrieveResponse.isCritical
            metadata = studyRetrieveResponse.metadata
            modality = studyRetrieveResponse.modality
            priorReports = studyRetrieveResponse.priorReports.map { it.toMutableList() }
            reportIds = studyRetrieveResponse.reportIds.map { it.toMutableList() }
            studyType = studyRetrieveResponse.studyType
            technologistNotes = studyRetrieveResponse.technologistNotes.map { it.toMutableList() }
            technologistTechnique = studyRetrieveResponse.technologistTechnique
