...
/**
 * Generates a tokenized URL that redirects users to the viewer interface only (no dictation) for
 * the specified study. Useful for read-only access or referring physicians. The URL includes
 * authentication and is time-limited.
 */
class StudyViewerOnlyRerouteUrlParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): StudyViewerOnlyRerouteUrlParams = builder().build()
    ...
    /** A builder for [StudyViewerOnlyRerouteUrlParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(studyViewerOnlyRerouteUrlParams: StudyViewerOnlyRerouteUrlParams) =
            apply {
                body = studyViewerOnlyRerouteUrlParams.body.toBuilder()
                additionalHeaders = studyViewerOnlyRerouteUrlParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    studyViewerOnlyRerouteUrlParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [StudyViewerOnlyRerouteUrlParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StudyViewerOnlyRerouteUrlParams =
            StudyViewerOnlyRerouteUrlParams(
                body.build(),
    ...
    /**
     * Request body for generating a viewer-only reroute URL. Requires viewer to be configured for
     * your clinic.
     */
    class Body
    ...
    private constructor(
        ...
        ) : this(studyId, studyInstanceUid, userId, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             */
            fun build(): Body =
                Body(studyId, studyInstanceUid, userId, additionalProperties.toMutableMap())
        }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(studyId, studyInstanceUid, userId, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{studyId=$studyId, studyInstanceUid=$studyInstanceUid, userId=$userId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is StudyViewerOnlyRerouteUrlParams &&
            body == other.body &&
    ...
    override fun toString() =
        "StudyViewerOnlyRerouteUrlParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
