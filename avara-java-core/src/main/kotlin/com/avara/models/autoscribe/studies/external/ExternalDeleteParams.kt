...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ExternalDeleteParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [ExternalDeleteParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [ExternalDeleteParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(externalDeleteParams: ExternalDeleteParams) = apply {
            body = externalDeleteParams.body.toBuilder()
            additionalHeaders = externalDeleteParams.additionalHeaders.toBuilder()
            additionalQueryParams = externalDeleteParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ExternalDeleteParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ExternalDeleteParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExternalDeleteParams &&
            body == other.body &&
    ...
    override fun toString() =
        "ExternalDeleteParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
