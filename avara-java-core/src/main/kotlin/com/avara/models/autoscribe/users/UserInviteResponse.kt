...
/**
 * Response for inviting a user to AutoScribe. Level is restricted to admin/member since owners
 * cannot be invited via API.
 */
...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(userInviteResponse: UserInviteResponse) = apply {
            canCreateReports = userInviteResponse.canCreateReports
            ...
            npiNumber = userInviteResponse.npiNumber
