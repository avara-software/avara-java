...
private constructor(
    ...
    private val data: JsonField<ReportDeliveredEventData>,
    ...
    private constructor(
        ...
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<ReportDeliveredEventData> = JsonMissing.of(),
     ...
     *   missing or null (e.g. if the server responded with an unexpected value).
     */
    fun data(): ReportDeliveredEventData = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<ReportDeliveredEventData> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<ReportDeliveredEventData>? = null
        ...
        /** Event payload containing report and study information */
        fun data(data: ReportDeliveredEventData) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed [ReportDeliveredEventData] value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<ReportDeliveredEventData>) = apply { this.data = data }
