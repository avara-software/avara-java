...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrgUpdateResponse].
         *
    ...
    /** A builder for [OrgUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orgUpdateResponse: OrgUpdateResponse) = apply {
            createdAt = orgUpdateResponse.createdAt
            isActive = orgUpdateResponse.isActive
            orgId = orgUpdateResponse.orgId
            orgName = orgUpdateResponse.orgName
            updatedAt = orgUpdateResponse.updatedAt
            userCount = orgUpdateResponse.userCount
            createdByApiKeyId = orgUpdateResponse.createdByApiKeyId
            createdByUserId = orgUpdateResponse.createdByUserId
            metadata = orgUpdateResponse.metadata
            additionalProperties = orgUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrgUpdateResponse].
         *
    ...
    fun validate(): OrgUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrgUpdateResponse &&
    ...
    override fun toString() =
        "OrgUpdateResponse{createdAt=$createdAt, isActive=$isActive, orgId=$orgId, orgName=$orgName, updatedAt=$updatedAt, userCount=$userCount, createdByApiKeyId=$createdByApiKeyId, createdByUserId=$createdByUserId, metadata=$metadata, additionalProperties=$additionalProperties}"
}
