...
/**
 * Removes a user's association with an organization, revoking their access to organization-specific
 * resources. The user account remains active but is no longer linked to this organization.
 */
...
private constructor(
    ...
    override fun toString() =
        "UserRemoveParams{orgId=$orgId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
