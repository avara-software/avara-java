...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [OrgReactivateResponse].
         *
    ...
    /** A builder for [OrgReactivateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(orgReactivateResponse: OrgReactivateResponse) = apply {
            createdAt = orgReactivateResponse.createdAt
            isActive = orgReactivateResponse.isActive
            orgId = orgReactivateResponse.orgId
            orgName = orgReactivateResponse.orgName
            updatedAt = orgReactivateResponse.updatedAt
            userCount = orgReactivateResponse.userCount
            createdByApiKeyId = orgReactivateResponse.createdByApiKeyId
            createdByUserId = orgReactivateResponse.createdByUserId
            metadata = orgReactivateResponse.metadata
            additionalProperties = orgReactivateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [OrgReactivateResponse].
         *
         ...
         */
        fun build(): OrgReactivateResponse =
    ...
    fun validate(): OrgReactivateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is OrgReactivateResponse &&
    ...
    override fun toString() =
        "OrgReactivateResponse{createdAt=$createdAt, isActive=$isActive, orgId=$orgId, orgName=$orgName, updatedAt=$updatedAt, userCount=$userCount, createdByApiKeyId=$createdByApiKeyId, createdByUserId=$createdByUserId, metadata=$metadata, additionalProperties=$additionalProperties}"
}
