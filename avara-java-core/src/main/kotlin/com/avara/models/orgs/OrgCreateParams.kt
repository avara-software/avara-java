...
/**
 * Creates a new organization with a unique identifier and name. Organizations can be used to group
 * and manage users, studies, and access permissions across the Avara platform.
 */
...
private constructor(
    ...
    private constructor(
        ...
        ) : this(orgName, metadata, mutableMapOf())
        ...
        private val hashCode: Int by lazy { Objects.hash(orgName, metadata, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{orgName=$orgName, metadata=$metadata, additionalProperties=$additionalProperties}"
    }
