...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExpressListResponse].
         *
    ...
    /** A builder for [ExpressListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(expressListResponse: ExpressListResponse) = apply {
            createdAt = expressListResponse.createdAt
            expressCustomerId = expressListResponse.expressCustomerId
            expressCustomerName = expressListResponse.expressCustomerName
            isActive = expressListResponse.isActive
            updatedAt = expressListResponse.updatedAt
            userCount = expressListResponse.userCount
            createdByApiKeyId = expressListResponse.createdByApiKeyId
            createdByUserId = expressListResponse.createdByUserId
            metadata = expressListResponse.metadata
            additionalProperties = expressListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExpressListResponse].
         *
     ...
     *   type.
     */
    fun validate(): ExpressListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpressListResponse &&
