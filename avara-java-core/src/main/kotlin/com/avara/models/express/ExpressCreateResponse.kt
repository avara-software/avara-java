...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExpressCreateResponse].
         *
    ...
    /** A builder for [ExpressCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(expressCreateResponse: ExpressCreateResponse) = apply {
            createdAt = expressCreateResponse.createdAt
            expressCustomerId = expressCreateResponse.expressCustomerId
            expressCustomerName = expressCreateResponse.expressCustomerName
            isActive = expressCreateResponse.isActive
            updatedAt = expressCreateResponse.updatedAt
            userCount = expressCreateResponse.userCount
            createdByApiKeyId = expressCreateResponse.createdByApiKeyId
            createdByUserId = expressCreateResponse.createdByUserId
            metadata = expressCreateResponse.metadata
            additionalProperties = expressCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ExpressCreateResponse].
         *
         ...
         */
        fun build(): ExpressCreateResponse =
     ...
     *   type.
     */
    fun validate(): ExpressCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpressCreateResponse &&
