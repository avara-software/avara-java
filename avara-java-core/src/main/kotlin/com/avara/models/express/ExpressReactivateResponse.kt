...
private constructor(
    ...
    /**
     * Custom key-value metadata for the Express customer. Maximum 50 pairs, keys up to 100 chars,
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ExpressReactivateResponse].
         *
    ...
    /** A builder for [ExpressReactivateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(expressReactivateResponse: ExpressReactivateResponse) = apply {
            createdAt = expressReactivateResponse.createdAt
            expressCustomerId = expressReactivateResponse.expressCustomerId
            expressCustomerName = expressReactivateResponse.expressCustomerName
            isActive = expressReactivateResponse.isActive
            updatedAt = expressReactivateResponse.updatedAt
            userCount = expressReactivateResponse.userCount
            createdByApiKeyId = expressReactivateResponse.createdByApiKeyId
            createdByUserId = expressReactivateResponse.createdByUserId
            metadata = expressReactivateResponse.metadata
            additionalProperties = expressReactivateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Custom key-value metadata for the Express customer. Maximum 50 pairs, keys up to 100
        ...
        /**
         * Returns an immutable instance of [ExpressReactivateResponse].
         *
         ...
         */
        fun build(): ExpressReactivateResponse =
    ...
    fun validate(): ExpressReactivateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ExpressReactivateResponse &&
    ...
    override fun toString() =
        "ExpressReactivateResponse{createdAt=$createdAt, expressCustomerId=$expressCustomerId, expressCustomerName=$expressCustomerName, isActive=$isActive, updatedAt=$updatedAt, userCount=$userCount, createdByApiKeyId=$createdByApiKeyId, createdByUserId=$createdByUserId, metadata=$metadata, additionalProperties=$additionalProperties}"
}
