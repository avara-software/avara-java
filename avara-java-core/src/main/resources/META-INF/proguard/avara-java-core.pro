...
-keep @com.fasterxml.jackson.databind.annotation.JsonSerialize class com.avarasoftware.** { *; }
-keep @com.fasterxml.jackson.databind.annotation.JsonDeserialize class com.avarasoftware.** { *; }

# Jackson uses reflection to serialize and deserialize our classes based on their constructors and annotated members.
-keepclassmembers class com.avarasoftware.** {
    <init>(...);
