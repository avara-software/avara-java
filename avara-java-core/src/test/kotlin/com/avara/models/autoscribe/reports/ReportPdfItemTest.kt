...
internal class ReportPdfItemTest {
    ...
    fun create() {
        ...
        assertThat(reportPdfItem.snapshotMetadata())
            .isEqualTo(
                StudyReportMetadata.builder()
                    .age("38 years")
                    .dateOfBirth("1985-07-20")
        ...
        assertThat(reportPdfItem.studyId()).isEqualTo("stu_1234567890abcdef1234567890abcdef")
        assertThat(reportPdfItem.studyInstanceUid())
    ...
    fun roundtrip() {
        ...
        val roundtrippedReportPdfItem =
            jsonMapper.readValue(
                jsonMapper.writeValueAsString(reportPdfItem),
                jacksonTypeRef<ReportPdfItem>(),
            )

        assertThat(roundtrippedReportPdfItem).isEqualTo(reportPdfItem)
    }
}
