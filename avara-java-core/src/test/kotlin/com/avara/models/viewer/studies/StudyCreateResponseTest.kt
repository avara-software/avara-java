...
internal class StudyCreateResponseTest {
    ...
    fun create() {
        ...
        assertThat(studyCreateResponse.severity()).isEqualTo(Severity.HIGH)
        ...
        assertThat(studyCreateResponse.studyViewerStatus()).isEqualTo(StudyViewerStatus.INCOMPLETE)
