...
internal class InvitationRetrieveResponseTest {
    ...
    fun create() {
        ...
        assertThat(invitationRetrieveResponse.clinicRole()).isEqualTo(ClinicRole.RADIOLOGIST)
        ...
        assertThat(invitationRetrieveResponse.invitedSource()).isEqualTo(InvitedSource.API)
        ...
        assertThat(invitationRetrieveResponse.level()).isEqualTo(UserLevel.MEMBER)
        assertThat(invitationRetrieveResponse.status()).isEqualTo(InvitationStatus.SENT)
