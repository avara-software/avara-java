...
package com.avarasoftware.core.http

import com.avarasoftware.client.okhttp.OkHttpClient
import com.avarasoftware.core.RequestOptions
import com.avarasoftware.core.Sleeper
import com.avarasoftware.errors.AvaraRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw AvaraRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            AvaraRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
