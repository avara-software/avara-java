...
[![Maven Central](https://img.shields.io/maven-central/v/com.avarasoftware/avara-java)](https://central.sonatype.com/artifact/com.avarasoftware/avara-java/0.2.0)
[![javadoc](https://javadoc.io/badge2/com.avarasoftware/avara-java/javadoc.svg)](https://javadoc.io/doc/com.avarasoftware/avara-java/0.2.0)
...
The REST API documentation can be found on [docs.avarasoftware.com](https://docs.avarasoftware.com). Javadocs are available on [javadoc.io](https://javadoc.io/doc/com.avarasoftware/avara-java/0.2.0).
...
```kotlin
implementation("com.avarasoftware:avara-java:0.2.0")
```
...
We are keen for your feedback; please open an [issue](https://www.github.com/avara-software/avara-java/issues) with questions, bugs, or suggestions.
